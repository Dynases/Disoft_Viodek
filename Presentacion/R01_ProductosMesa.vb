...
#End Region
    ...
    Private Sub cbMesa_ValueChanged(sender As Object, e As EventArgs) Handles cbMesa.ValueChanged

    End Sub

    Private Sub LabelX2_Click(sender As Object, e As EventArgs)
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        dt = L_fnReporteProductosMesasT()

        If dt.Rows.Count > 0 Then
            Dim objrep As New R_ProductoMesaGeneral
